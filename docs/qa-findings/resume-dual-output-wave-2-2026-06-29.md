...
Wave 2 complete. Resume generation now emits two permanent PDFs (`Complete` and optimized default), LinkedIn resume artifact generation was removed, and visual checkpoints were captured for both application-layout variants.

## Verified

| Check                                                             | Result                 |
| ----------------------------------------------------------------- | ---------------------- |
| `pnpm generate:resume` emits `Zeddrix-Fabian-Resume-Complete.pdf` | Pass                   |
| `pnpm generate:resume` emits `Zeddrix-Fabian-Resume.pdf`          | Pass                   |
