...
| `tests/e2e/home/home-carousel-touch.e2e.test.ts` | home | 2 | — | focused |
...
| `tests/e2e/journeys/journey-preview-settings-persistence.e2e.test.ts` | journeys | 3 | journey | golden-path |
| `tests/e2e/journeys/journey-seo-and-external-links.e2e.test.ts` | journeys | 3 | journey | golden-path |
