...
<section id="contact" class={`contact-section ${variant === 'compact' ? 'compact' : ''}`}>
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="text-center mb-12">
			<h2 class="section-title">Get In Touch</h2>
			<p class="section-description">Let's discuss your next project or just say hello!</p>
		</div>
...
<style>
	...
	.contact-link {
		@apply flex items-center gap-3 text-text-primary hover:text-primary transition-colors;
		@apply no-underline;
	}
	...
	.social-icon {
		@apply w-10 h-10 flex items-center justify-center rounded-full bg-surface border border-border;
		@apply hover:bg-primary hover:border-primary hover:text-white transition-all;
	}
	...
	.contact-form {
		@apply bg-surface rounded-lg p-8 border border-border;
	}
	...
	.submit-button {
		@apply w-full px-6 py-3 bg-primary text-white font-medium rounded-lg;
		@apply hover:bg-primary/90 transition-colors;
		@apply focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-surface;
	...
	.status-message {
		@apply text-sm font-medium p-3 rounded-lg;
	}
