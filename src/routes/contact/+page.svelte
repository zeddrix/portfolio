...
<Section background="white" padding="large">
	<Container maxWidth="md">
		<div class="text-center space-y-6">
			<h1 class="text-4xl md:text-5xl font-bold text-neutral-900">Get In Touch</h1>
			...
			{#each contactInfo as info}
				<Card variant="elevated" padding="large">
					<div class="flex flex-col items-center text-center space-y-3">
						...
						<h3 class="text-lg font-bold text-neutral-900">{info.title}</h3>
		...
		<Card variant="elevated" padding="large">
			<div class="space-y-6">
				<div class="text-center">
					<h2 class="text-2xl md:text-3xl font-bold text-neutral-900 mb-2">Send a Message</h2>
					<p class="text-neutral-600">I'll respond within 24 hours</p>
				</div>
...
<Section background="gray" padding="large">
	<Container maxWidth="md">
		<div class="text-center space-y-6">
			<h2 class="text-2xl md:text-3xl font-bold text-neutral-900">Connect With Me</h2>
			<p class="text-neutral-600">Follow me on social media for updates and insights</p>
			...
			<div class="flex justify-center gap-6">
				<a
					...
					class="p-3 rounded-full bg-neutral-900 text-white hover:bg-neutral-700 transition-colors"
					aria-label="GitHub"
				>
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="p-3 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors"
					aria-label="LinkedIn"
				>
					<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
						<path
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="p-3 rounded-full bg-sky-500 text-white hover:bg-sky-600 transition-colors"
					aria-label="Twitter"
				>
					<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
						<path
